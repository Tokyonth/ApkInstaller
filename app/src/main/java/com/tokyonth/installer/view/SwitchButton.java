...
public class SwitchButton extends AppCompatCheckBox {
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColorUnchecked = context.getResources().getColor(R.color.colorBackground);
        mBackgroundColorChecked = context.getResources().getColor(R.color.colorAccent);
        // 点击时开始动画
